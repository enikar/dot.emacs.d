(custom-set-variables
 ...
 '(package-selected-packages
   '(corfu-doc kind-icon cape corfu deadgrep duplicate-thing embark embark-consult popper consult-flyspell consult-ls-git consult-yasnippet consult consult-ag consult-flycheck ctrlf marginalia orderless prescient vertico vterm dimmer vcard eev smalltalk-mode geiser-guile geiser-racket hl-todo yari flycheck-raku nim-mode racket-mode libgit magit-libgit realgud-byebug realgud-pry erlang systemd lua-mode fzf latex-extra latex-math-preview latex-preview-pane latexdiff nocomments-mode json-mode evil-visualstar ripgrep emojify evil-nerd-commenter evil-string-inflection attrap cmake-mode dune ocp-indent utop flx hasky-extensions hasky-stack evil-lion flycheck-guile ace-link ag all-the-icons all-the-icons-dired all-the-icons-ibuffer anzu auctex auto-compile avy avy-flycheck cider cider-hydra clojure-mode clojure-mode-extra-font-locking clojure-snippets dante diminish doom-modeline evil evil-anzu evil-args evil-avy evil-better-visual-line evil-embrace evil-goggles evil-iedit-state evil-leader evil-magit evil-matchit evil-mc evil-mc-extras evil-multiedit evil-numbers evil-org evil-quickscope evil-ruby-text-objects evil-surround evil-tutor eyebrowse fill-column-indicator flycheck flycheck-ocaml flycheck-yamllint geiser gitconfig-mode go-dlv go-eldoc go-gopath go-imenu go-imports go-mode go-snippets haskell-mode haskell-snippets helpful highlight-indent-guides highlight-numbers highlight-parentheses hydra iedit importmagic inf-ruby ix magit markdown-mode merlin merlin-eldoc multiple-cursors openwith paradox persistent-scratch persp-mode rainbow-delimiters rainbow-identifiers raku-mode retrie robe rspec-mode rtags rubocop ruby-end rustic semi session slime transient treemacs treemacs-evil treemacs-magit treemacs-persp tuareg undo-tree use-package w3m which-key with-editor xcscope yaml-mode yard-mode yasnippet yasnippet-snippets))
