(custom-set-variables
 ...
 '(package-selected-packages
   '(vterm dimmer vcard eev smalltalk-mode alchemist flycheck-elixir geiser-guile geiser-racket hl-todo yari flycheck-raku nim-mode racket-mode libgit magit-libgit realgud-byebug realgud-pry elixir-mode erlang systemd lua-mode fzf latex-extra latex-math-preview latex-preview-pane latexdiff nocomments-mode ivy-historian json-mode evil-visualstar pt ripgrep ivy-avy emojify evil-nerd-commenter evil-string-inflection attrap cmake-mode dune ocp-indent utop flx hasky-extensions hasky-stack evil-lion flycheck-guile ace-link ag all-the-icons all-the-icons-dired all-the-icons-ibuffer all-the-icons-ivy-rich anzu auctex auto-compile avy avy-flycheck cider cider-hydra clojure-mode clojure-mode-extra-font-locking clojure-snippets company-anaconda company-auctex company-cabal company-fuzzy company-ghci company-go company-inf-ruby company-plsense company-rtags company-shell counsel counsel-etags counsel-gtags counsel-org-capture-string counsel-org-clock counsel-projectile counsel-tramp dante diminish doom-modeline evil evil-anzu evil-args evil-avy evil-better-visual-line evil-embrace evil-goggles evil-iedit-state evil-leader evil-magit evil-matchit evil-mc evil-mc-extras evil-multiedit evil-numbers evil-org evil-quickscope evil-ruby-text-objects evil-smartparens evil-surround evil-tutor eyebrowse fill-column-indicator flycheck flycheck-ocaml flycheck-yamllint flyspell-correct-ivy geiser gitconfig-mode go-dlv go-eldoc go-gopath go-imenu go-imports go-mode go-projectile go-snippets haskell-mode haskell-snippets helpful highlight-indent-guides highlight-numbers highlight-parentheses hydra ibuffer-projectile iedit importmagic inf-ruby ivy-explorer ivy-hydra ivy-rich ivy-yasnippet ix magit markdown-mode merlin merlin-eldoc multiple-cursors openwith paradox persistent-scratch persp-mode persp-mode-projectile-bridge rainbow-delimiters rainbow-identifiers raku-mode retrie robe rspec-mode rtags rubocop ruby-end rustic semi session slime slime-company smartparens swiper transient treemacs treemacs-evil treemacs-magit treemacs-persp treemacs-projectile tuareg undo-tree use-package w3m which-key with-editor xcscope yaml-mode yard-mode yasnippet yasnippet-snippets))
