(custom-set-variables
 ...
 '(package-selected-packages
   '(gitconfig yasnippet-snippets visual-regexp avy-embark-collect dumb-jump fringe-helper typescript-mode jq-format symbol-overlay hlint-refactor restart-emacs vdiff evil-vimish-fold evil-mc evil-mc-extras treemacs-all-the-icons general wgrep wgrep-ag package crystal-mode realgud-byebug realgud-pry robe yard-mode consult-flycheck consult-flyspell inf-ruby evil-ruby-text-objects ruby-end yari consult-dir affe consult consult-ag consult-ls-git consult-recoll consult-yasnippet embark-consult vertico all-the-icons-completion py-snippets evil-org kind-icon cape corfu deadgrep duplicate-thing embark popper ctrlf marginalia orderless prescient vterm dimmer smalltalk-mode geiser-guile geiser-racket flycheck-raku nim-mode racket-mode libgit magit-libgit systemd lua-mode fzf latex-extra latex-math-preview latex-preview-pane latexdiff nocomments-mode json-mode evil-visualstar ripgrep emojify evil-nerd-commenter evil-string-inflection attrap cmake-mode dune ocp-indent utop evil-lion flycheck-guile ace-link ag all-the-icons all-the-icons-dired all-the-icons-ibuffer anzu auctex auto-compile avy dante diminish doom-modeline evil evil-anzu evil-avy evil-embrace evil-goggles evil-iedit-state evil-matchit evil-multiedit evil-numbers evil-quickscope evil-surround evil-tutor eyebrowse fill-column-indicator flycheck flycheck-ocaml flycheck-yamllint geiser haskell-mode haskell-snippets helpful highlight-indent-guides highlight-numbers highlight-parentheses hydra iedit importmagic magit markdown-mode merlin merlin-eldoc openwith paradox persistent-scratch rainbow-delimiters rainbow-identifiers raku-mode retrie rustic slime transient treemacs treemacs-evil treemacs-magit tuareg undo-tree use-package which-key with-editor xcscope yaml-mode))
